...
# 확장 언패킹
a, *b, c = s  # 별(*)은 무조건 한 변수에만
print(a, b, c)  # a와 c의 타입은 string, b는 list
...
print(a[::1])  # Python 출력 (step이 양수이면 끝까지, 생략 가능, 마지막 인덱스 포함)
